...
export const Testimonials = () => {
    // here is the thing that make the infinate loop there
    ...
    <section id="testimonials" className="py-32 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          uppercase animation-fade-in"
          >
            What People Say
          </span>
          <h2
            className="text-4xl md:text-5xl 
          font-bold mt-4 mb-6 animation-fade-in 
        ...
        {/* main thing in to move that testimonials logic here */}
